...
const Myprofile = () => {
  ...
  const update_profile = async (e) => {
    ...
    try {
      if (!file)
        return (myresponse = "No files were uploaded."), setmessage(true);
      ...
      const res = await axios.post(
        `${process.env.REACT_APP_SERVER}/api/upload_avatar`,
        formData,
        {
  ...
  const updatePic = async (avatar) => {
    try {
      ...
      setloading(false);
      toast.success("Profile Picture Updated.Refresh Page", {
        position: "top-right",
      });
    } catch (err) {
              ...
              <div className="col-md-6 col-10 mx-auto">
                <form>
                  ...
                  <div className="col-12">
                    ...
                    <span>
                      {" "}
                      <button className="profile-edit-btn2" onClick={openmodal}>
                        cancel
                      </button>
                    </span>
                  </div>
