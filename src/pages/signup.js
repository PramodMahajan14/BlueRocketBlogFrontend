  ...
  const SignupUser = async (e) => {
    ...
    try {
      const response = await fetch(
        `${process.env.REACT_APP_SERVER}/user/register`,
        {
          method: "POST",
          headers: {
  ...
  return (
    <>
      <div style={{ width: "100%", height: "100vh" }}>
        ...
        {/*success message */}
        <div
          className={successmessage ? " message " : "ui green message visible"}
        >
          <i onClick={hidemessage} class="close icon"></i>
          ...
          <form className="ui form" id="sinup">
            <div className="ui segment">
              <div className="ui center aligned basic segment">
                  ...
                  <div className="field">
                    <div className="ui left input">
                      <input
                        type="text"
                        name="userid"
                        placeholder="User id eg.jon_@22"
                        value={user.userid}
                        onChange={userInput}
                      />
                    </div>
                ...
                <h4 className="ui horizontal divider header" id="divi">
                  OR
                </h4>
                New here?{" "}
                <Link to={"/signin"}>
